...
export const RolfLogo = ({ className = "" }: { className?: string }) => (
  <svg
  ...
  >
    <g transform="translate(30, 0) skewX(-10)" fillRule="evenodd">
      <path d="M 0 0 h 40 v 24 h -40 z" fill="#1D1D1D"/>
      <path d="M 0 38 h 40 v 24 h -40 z" fill="#E3000F"/>
      <path d="M 0 76 h 40 v 24 h -40 z" fill="#FFCD00"/>
...
export const RServiceLogo = ({ className = "" }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 780 120"
    width="100%"
    ...
    className={className}
  >
    <g transform="translate(30, 10) skewX(-10)" fill="#FFCD00" fillRule="evenodd">
