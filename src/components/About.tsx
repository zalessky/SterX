        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-gray-500 leading-relaxed font-museo-300">
              <p>
                СТО ROLF — это современный технический центр, специализирующийся на профессиональном обслуживании легковых автомобилей. Мы объединили многолетний опыт наших мастеров с инновационными технологиями смазочных материалов ROLF.
              </p>
              <p>
